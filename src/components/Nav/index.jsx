...
function NavTabs({ currentPage, handlePageChange }) {
  ...
  return (
<nav class="custom-navbar navbar navbar-expand-lg navbar-light bg-black py-3">
  <div class="container">
    <a id="logo" class="mx-3 navbar-brand text-white" href="#">Jesus Gonzalez</a>
    <button id="toggle" class="custom-toggler navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navmenu">

...
<nav class="navbar navbar-expand-lg navbar-light bg-black">
  <div class="container-fluid">
    <a class="navbar-brand text-white logo" href="#">Jesus Gonzalez</a>
    <button class="custom-toggler navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navmenu">
    ...
    <div class="collapse navbar-collapse" id="navmenu">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
        <a id='about' href="#about" onClick={() => handlePageChange('About')} className='nav-link text-white'>About</a>
        </li>
        <li class="nav-item">
